...
if __name__ == '__main__':
    ...
    print('Output after conversation of 2 = ', convertToWords(2))
    print('Output after conversation of 32 = ', convertToWords(32))
    print('Output after conversation of 512 = ', convertToWords(512))
    ...
    print('Output after conversation of 99999999999= ',convertToWords(99999999999))
